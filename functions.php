...
// Front Page Property Slider
  include 'front-page-listing-slider/front-page-listing-slider.php';
// Customizer
...
// For the listings page. Adds /housing-package content to modal window
  ...
  function ah_city_map($city, $cty_state) {
    ...
    <script>
      ...
      google.maps.event.addDomListener(window, 'load', function(){ estateMapping.init_property_map(property_list, defaultmapcenter); });
    ...
    <div class="container">
      ...
      <div id="request-quote-for" class="six columns offset-by-two alpha omega">
        ...
        <div class="quote-form">
          ...
          <?php /*echo do_shortcode($form_sc);*/ echo do_shortcode('[gravityform id="10" name="City Request a Quote" title="false" description="false" field_values="city='.$form_city.'&state='.$form_state.'"]'); ?>
...
// Enqueue Scripts and Styles
  ...
  function ah_scripts_method() {
    ...
    //wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Raleway:500,600,800,700,400', array(), '',
    // 'all' );
    
    //wp_enqueue_style('font-awesome', 'https://use.fontawesome.com/releases/v5.5.0/css/all.css', array(), '', 'all');
